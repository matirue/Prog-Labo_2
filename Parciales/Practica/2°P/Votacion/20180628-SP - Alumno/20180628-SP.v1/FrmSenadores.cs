...
namespace _20180628_SP.v1
{
    public partial class FrmSenadores : Form
    {
        ...
        //En el manejador del evento Click del botón 
        //btnSimular enlazar el evento de la votación 
        //con su manejador en el formulario, y lanzar el método Simular de votacion en un nuevo Thread.
