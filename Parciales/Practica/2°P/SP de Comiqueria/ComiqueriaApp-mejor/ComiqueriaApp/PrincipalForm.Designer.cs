namespace ComiqueriaApp
{
    partial class PrincipalForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.timerUnSegundo = new System.Windows.Forms.Timer(this.components);
            ...
            // timerUnSegundo
            // 
            this.timerUnSegundo.Enabled = true;
            this.timerUnSegundo.Interval = 1000;
            this.timerUnSegundo.Tick += new System.EventHandler(this.timerUnSegundo_Tick);
            // 
            // PrincipalForm
            // 
        ...
        private System.Windows.Forms.Timer timerUnSegundo;
    }
}